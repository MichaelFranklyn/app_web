...
export const valueForChoice = (choice: ColumnChoice | undefined, cells: string[]): string => {
  if (!choice) return "";
...
export const distinctValues = (rows: string[][], choice: ColumnChoice | undefined): string[] => {
  if (!choice) return [];
