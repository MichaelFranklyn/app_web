              ...
              help={
                <div className="flex flex-col gap-2">
                  ...
                  <Title variant="body-sm">
                    ...
                    Quando o vendedor importar um pedido dela, o sistema já lê
                    os itens automaticamente, sem precisar apontar as colunas
                    toda vez.
                  </Title>
                </div>
              }
            ...
            <TemplateCard
              ...
              help={
                <div className="flex flex-col gap-2">
                  ...
                  <Title variant="body-sm">
                    Guarda como as colunas da tabela desta fábrica foram
                    mapeadas (níveis, IPI, NCM, impostos). Nas próximas
                    importações você só sobe o novo arquivo — o mapeamento já
                    vem preenchido.
                  </Title>
                </div>
              }
