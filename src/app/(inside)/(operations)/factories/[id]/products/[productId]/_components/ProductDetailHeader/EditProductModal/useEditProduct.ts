...
export function useEditProduct({ product, onSuccess }: EditProductModalProps) {
        ...
        sections: [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                placeholder: "Escolha o rótulo (ex: Caixa)",
                required: true,
  ...
  const handleSubmit = async (data: Record<string, unknown>) => {
    ...
    const isActive = extractSelectValue(data.isActive);
