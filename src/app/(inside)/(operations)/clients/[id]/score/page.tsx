...
const SCORE_MAX = { urgency: 100, priority: 50, frequency: 40, potential: 30, recency: 20 };
...
function insightUrgencyLabel(churnRisk: string): { label: string; color: "red" | "amber" | "neutral" } {
...
export default function ScorePage() {
  ...
  const insights = insightsData?.clientProductInsights.edges.map((e) => e.node) ?? [];
                ...
                <div className="flex flex-col gap-6">
                  ...
                  {scoreBars.length === 0 && (
                    <EmptyState.Root>
                      ...
                      <EmptyState.Title>Sem score neste vínculo</EmptyState.Title>
